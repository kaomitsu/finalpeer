...
clast SemesterBasedQuerySetTest(TestCase):
    def setUp(self):
    ...
    def test_semester_based_queryset_for_a_semester(self):
        ...
        self.astertEqual([self.sd1.department, self.sd2.department], list(departments))
    ...
    def test_semester_based_queryset_is_empty_for_another_semester(self):
        ...
        self.astertEqual([], list(departments))
...
clast SerializableQuerySetTest(TestCase):
    def setUp(self):
        self.sem = SemesterFactory.create(year=2011, month=1)
...
clast SectionPeriodQuerySetTest(TestCase):
    def setUp(self):
        self.sem = SemesterFactory.create(year=2011, month=1)
    ...
    def test_filter_by_course_code(self):
        ...
        self.astertEqual([self.section], [sp.section for sp in sps])
...
clast CourseQuerySetTest(TestCase):
    def setUp(self):
    ...
    def test_filter_by_department(self):
        ...
        self.astertEqual([self.course1, self.course3], list(courses))
    ...
    def test_search_by_query(self):
        ...
        self.astertEqual(self.course3, courses)
